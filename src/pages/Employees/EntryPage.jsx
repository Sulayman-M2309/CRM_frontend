      ...
      <div className="entry-page-content">
        <div className="entry-image flex flex-col justify-center items-center mb-10 w-auto">
          <img
            ...
            alt=""
            className="sm:max-w-sm md:max-w-md lg:max-w-md xl:max-w-lg"
          />
          <h1 className="text-xl text-blue-600 font-bold min-[300px]:text-lg min-[300px]:text-center">
        ...
        <div className="buttons flex justify-center placeholder:items-center gap-5">
          <Link to={"/auth/employee/login"}>
            <Button className="bg-purple-600 text-white font-bold text-lg">
              Employee
            </Button>
          </Link>
